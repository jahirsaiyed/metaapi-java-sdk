...
public class ProvisioningProfileClient {
     ...
     */
    public CompletableFuture<ProvisioningProfileDto> getProvisioningProfile(String id) throws Exception {
        HttpRequestOptions opts = new HttpRequestOptions(host + "/users/current/provisioning-profiles/" + id, Method.GET);
        opts.getHeaders().put("auth-token", token);
    ...
    public CompletableFuture<Void> uploadProvisioningProfileFile(
        ...
        return uploadProvisioningProfileFile(
     ...
     */
    public CompletableFuture<Void> deleteProvisioningProfile(String id) throws Exception {
        HttpRequestOptions opts = new HttpRequestOptions(host + "/users/current/provisioning-profiles/" + id, Method.DELETE);
        opts.getHeaders().put("auth-token", token);
    ...
    public CompletableFuture<Void> updateProvisioningProfile(
        ...
        HttpRequestOptions opts = new HttpRequestOptions(host + "/users/current/provisioning-profiles/" + id, Method.PUT);
        opts.getHeaders().put("auth-token", token);
        opts.setBody(provisioningProfile);
        return httpClient.request(opts).thenApply((body) -> null);
    }
