...
import cloud.metaapi.sdk.clients.models.ProvisioningProfileUpdateDto;
...
public class ProvisioningProfile {
     ...
     */
    public CompletableFuture<Void> remove() throws Exception {
     ...
     */
    public CompletableFuture<Void> uploadFile(String fileName, String filePath) throws Exception {
     ...
     * @return completable future which resolves when the file is uploaded
     */
    public CompletableFuture<Void> uploadFile(String fileName, InputStream fileContents) throws Exception {
