...
class TerminalStateTest {
    ...
    void testReturnsOrders() {
        ...
        state.onOrderUpdated(new MetatraderOrder() {{ id = "1"; openPrice = Optional.of(10.0); }});
        state.onOrderUpdated(new MetatraderOrder() {{ id = "2"; }});
        state.onOrderUpdated(new MetatraderOrder() {{ id = "1"; openPrice = Optional.of(11.0); }});
        ...
        assertThat(state.getOrders()).usingRecursiveComparison().isEqualTo(List.of(
            new MetatraderOrder() {{ id = "1"; openPrice = Optional.of(11.0); }}
        ));
    }
    ...
    void testUpdatesAccountEquityAndPositionProfitOnPriceUpdate() {
        ...
        state.onPositionUpdated(new MetatraderPosition() {{
            ...
            profit = 100;
            volume = 2;
            realizedProfit = Optional.empty();
            unrealizedProfit = Optional.empty();
        }});
        state.onPositionUpdated(new MetatraderPosition() {{
            id = "2";
            symbol = "AUDUSD";
