...
class ProvisioningProfileApiTest {
    ...
    void testRetrievesProvisioningProfiles(ProvisioningProfileDto expectedDto) throws Exception {
        Mockito.when(client.getProvisioningProfiles(Optional.of(4), Optional.of("new")))
        ...
        List<ProvisioningProfile> actualProfiles = api.getProvisioningProfiles(Optional.of(4), Optional.of("new")).get();
